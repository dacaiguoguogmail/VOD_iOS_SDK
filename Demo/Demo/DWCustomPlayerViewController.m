...
- (void)viewDidLoad
{
    ...
    DWAPPDELEGATE.allowScreenRotation = YES;
...
- (void)viewWillDisappear:(BOOL)animated{
    ...
    DWAPPDELEGATE.allowScreenRotation = NO;
...
-(void)durationSlidersetting
{
    ...
    [self.durationSlider addTarget:self action:@selector(durationSliderEnded:) forControlEvents: UIControlEventTouchUpInside];
